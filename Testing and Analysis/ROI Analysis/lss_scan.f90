program lss_scan
    ...
    !Surface-in file
    open(unit=50,file="ROI 03 Final angle  45.00 SurfaceIn.csv")
    !Surface-out file
    open(unit=60,file="ROI 03 Final angle  45.00 SurfaceOut.csv")
